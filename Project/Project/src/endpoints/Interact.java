...
public class Interact {
    ...
    public static int generatePoW (String message) throws NoSuchAlgorithmException{
        return proof.PoW.PoWGen(message);
    }

    public static boolean verifyPoW(int nonce, String message) throws NoSuchAlgorithmException{
